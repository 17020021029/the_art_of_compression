...
public:
   ...
   * splitting lines. It will also call helper function buildTree.
    ...
    */
   PNG render();
   void render(PNG & renderPNG,Node* sub_root);
   /*
   ...
   * You may want a recursive helper function for this one.
   ...
   void prune(double pct, int tol,Node* sub_root);
   long double get_leaves(Node* sub_root);
   long double get_total_leaves(int tol,Node* sub_root,RGBAPixel sub_avg);
